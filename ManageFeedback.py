...
# Layout Templates
title_temp ="""
	<div style="background-color: cornflowerblue;padding: 10px;border-radius: 8px;margin: 15px;">
...
article_temp ="""
	<div style="background-color: cornflowerblue;padding: 10px;border-radius: 8px;margin: 10px;">
	<h4 style="color: white;text-align: center;">{}</h1>
	<h6>Author: {}</h6> 
	<h6>Post Date: {}</h6>	
	<br/>
...
full_message_temp ="""
	<div style="background-color: lightsteelblue;overflow-x: auto;padding: 10px;border-radius: 8px;margin: 10px;">
...
def main():
	...
	choice = st.sidebar.selectbox("Select an Item:", menu)
	...
	if choice == "Home":
		...
		html_temp = """
			<div style="background-color:{};padding:3px;border-radius:8px">
